...
SECRET_KEY = 'django-insecure-z8fj+m^*%aohfawtap+ldy-5)#j0*bqz@n028ps3kb%+8!a6*p'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'TasksAPI',
    'DESCRIPTION': """
    Sistema API REST para CRUD de Tareas (Tasks)
    
    Creado por. Víctor J. | Django Rest Framework
    """,
    'VERSION': '1.0.0',
